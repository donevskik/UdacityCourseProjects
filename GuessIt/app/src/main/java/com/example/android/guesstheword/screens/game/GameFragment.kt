...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Log.i("GameFragment", "ViewModelProvidersof called")
        ...
        gameViewModel.eventBuzzing.observe(viewLifecycleOwner, Observer { buzzType ->
            if (!(buzzType.pattern contentEquals BuzzType.NO_BUZZ.pattern)) {
                buzz(buzzType.pattern)
                gameViewModel.onBuzzComplete()
                Log.i("GameFragment", "Buzz ${buzzType.pattern}")
            }
        })
